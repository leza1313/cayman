    ...
    <body id="cover">
        ...
        <div align = "center" >
         <div style = "width:600px; border: solid 1px #333333; background-color: #666 " align = "left">
            <div style = "background-color:#444; color:#FFFFFF; padding:3px;"><b>Añadir guitarra</b></div>
				
            <div style = "margin:30px">
               
               <form action = "anadirguitarra.php" method = "post" bg: #fff>
